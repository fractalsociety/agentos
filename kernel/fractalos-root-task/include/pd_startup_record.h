 ...
 *
 * Several FractalOS protection domains are "parameterized": a single ELF image
 ...
 * (see fos-3ev).  This header replaces that TEMPORARY default with a
...
#ifndef FRACTALOS_PD_STARTUP_RECORD_H
#define FRACTALOS_PD_STARTUP_RECORD_H
 ...
 * change wants a project-wide constant in fractalos.h, that addition is tracked
 * separately (see fos-3ev OUT-OF-SCOPE) — fractalos.h is owned elsewhere.
 */
...
#endif /* FRACTALOS_PD_STARTUP_RECORD_H */
