/*
 * FractalOS WASM3 Host — Integration layer for WASM execution in swap slots
 *
 * This bridges wasm3 (WASM interpreter) with the FractalOS swap slot PD.
 * It provides:
 ...
 * the WASM module's __fractalos_heap_stats export (if present).
