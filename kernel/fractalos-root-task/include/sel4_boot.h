 ...
 *
 * For FRACTALOS_TEST_HOST builds (no seL4 SDK available) this header provides
 ...
 * FRACTALOS_CTX_ARG0 instead of a hardcoded field name.
 */
#  if defined(__riscv)
#    define FRACTALOS_CTX_PC    pc   /* RISC-V: program counter */
#    define FRACTALOS_CTX_SP    sp   /* RISC-V: stack pointer */
#    define FRACTALOS_CTX_ARG0  a0   /* RISC-V: first argument register */
#    define FRACTALOS_CTX_ARG1  a1   /* RISC-V: second argument register */
#  elif defined(__aarch64__)
#    define FRACTALOS_CTX_PC    pc   /* AArch64: program counter */
#    define FRACTALOS_CTX_SP    sp   /* AArch64: stack pointer */
#    define FRACTALOS_CTX_ARG0  x0   /* AArch64: first argument register */
#    define FRACTALOS_CTX_ARG1  x1   /* AArch64: second argument register */
#  elif defined(__x86_64__)
#    define FRACTALOS_CTX_PC    rip  /* x86-64: instruction pointer */
#    define FRACTALOS_CTX_SP    rsp  /* x86-64: stack pointer */
#    define FRACTALOS_CTX_ARG0  rdi  /* x86-64 SysV ABI: first integer argument */
#    define FRACTALOS_CTX_ARG1  rsi  /* x86-64 SysV ABI: second integer argument */
#  else
#    define FRACTALOS_CTX_PC    pc   /* fallback */
#    define FRACTALOS_CTX_SP    sp   /* fallback */
#    define FRACTALOS_CTX_ARG0  x0   /* fallback */
#    define FRACTALOS_CTX_ARG1  x1   /* fallback */
#  endif
...
#define FRACTALOS_CTX_PC    pc
#define FRACTALOS_CTX_SP    sp
#define FRACTALOS_CTX_ARG0  x0
#define FRACTALOS_CTX_ARG1  x1
