...
#include <stdint.h>
#include "fractalos.h"        /* fractalos_priority_t */
#include "sel4_ipc.h"       /* sel4_call, sel4_msg_t */

/* ── seL4 MCS priority-donation API ─────────────────────────────────────── */

/*
 * fractalos_self_tcb_cap() — returns this PD's own TCB capability.
 *
...
/*
 * PD-local priority constants (mirror fractalos.system priorities).
