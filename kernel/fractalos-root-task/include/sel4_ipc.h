/*
 * sel4_ipc.h — seL4 IPC message abstractions for FractalOS service PDs
 *
 ...
 * that all FractalOS service PDs use.
 *
 ...
 * FRACTALOS_IPC_REPLY_CAP (cap slot 9) is reserved for this purpose.  The root
 ...
 * In FRACTALOS_TEST_HOST builds the framework.h mock layer provides stubs;
...
/*
 * FRACTALOS_IPC_REPLY_CAP — CNode slot reserved for the MCS reply object cap.
 *
 ...
 */
#define FRACTALOS_IPC_REPLY_CAP  ((seL4_CPtr)9u)
...
#  ifdef CONFIG_KERNEL_MCS
    (void)seL4_Recv(ep, &_badge, FRACTALOS_IPC_REPLY_CAP);
#  else
                                            ...
                                            sel4_msg_t *req)
{
    ...
    seL4_Word _badge = 0;
#  ifdef CONFIG_KERNEL_MCS
    (void)seL4_ReplyRecv(ep, _info, &_badge, FRACTALOS_IPC_REPLY_CAP);
#  else
