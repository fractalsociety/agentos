 ...
 * constants and FractalOS-specific extensions in that case.
 *
 * Test-host builds (FRACTALOS_TEST_HOST): no seL4 SDK available; this header
...
#define FRACTALOS_MEMORY_FENCE()      __asm__ volatile ("" ::: "memory")
...
#    define FRACTALOS_MEMORY_FENCE() __asm__ volatile ("fence rw,rw" ::: "memory")
...
#    define FRACTALOS_MEMORY_FENCE() __asm__ volatile ("dsb sy" ::: "memory")
...
#    define FRACTALOS_MEMORY_FENCE() __asm__ volatile ("mfence" ::: "memory")
#  endif
...
#define FRACTALOS_BOOTINFO_HEADER_ELF   0x4147u  /* 'AG' */

/* ── ELF region descriptor (FractalOS extension) ────────────────────────────── */

/*
 * fractalos_elf_region_t — describes one embedded PD ELF in the extra BootInfo.
 *
