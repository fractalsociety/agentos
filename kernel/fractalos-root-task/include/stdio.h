/*
 * Bare-metal stdio.h stub for FractalOS/seL4 freestanding build.
 * wasm3 uses printf/snprintf for debug output (overridden in m3_config).
 *
 * Under FRACTALOS_TEST_HOST (host-compiled unit / integration tests) we
...
#else /* !FRACTALOS_TEST_HOST — bare-metal freestanding build */
