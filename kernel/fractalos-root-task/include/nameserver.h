/*
 * FractalOS NameServer — Public Interface
 *
 ...
 * These must match the channel assignments in fractalos.system.
 */
 ...
 * In FRACTALOS_TEST_HOST builds the framework.h mock layer provides
