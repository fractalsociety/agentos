 ...
 * FractalOS VMM binding protocol (guest_contract.h) and the generic VM
 * lifecycle API (vmm_contract.h).
 *
 * Channel: (assigned in fractalos.system; controller → freebsd_vmm)
 * Opcodes: MSG_VM_* / OP_VM_* (see fractalos.h)
 *
 * Invariants:
