 ...
 *
 * Channel: SWAPSLOT_CH_CONTROLLER (from slot perspective; see fractalos.h)
 * Opcodes: MSG_VIBE_SLOT_* (see fractalos.h)
 *
 * Invariants:
...
/* ─── Channel IDs ────────────────────────────────────────────────────────── */
/* SWAPSLOT_CH_CONTROLLER = 0 (from swap slot perspective; see fractalos.h) */
