...
/* TX descriptor chaining: heads 0..31 hold virtio-net headers; tails 32..63
 * point at the caller frame still resident in the shared DMA arena. */
#define NET_DMA_TX_CHAIN_HEADS      32u
#define NET_DMA_TX_CHAIN_TAIL0      32u
_Static_assert((NET_DMA_TX_CHAIN_HEADS * 2u) <= NET_DMA_QUEUE_DEPTH,
               "TX chain heads+tails fit VirtIO queue");
_Static_assert(NET_DMA_TX_CHAIN_TAIL0 == NET_DMA_TX_CHAIN_HEADS,
               "TX chain tails start immediately after heads");
