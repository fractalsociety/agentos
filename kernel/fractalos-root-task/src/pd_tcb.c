                            ...
                            seL4_Word arg1)
{
    ...
    regs.FRACTALOS_CTX_PC = entry; /* instruction pointer: ELF entry symbol */
     ...
     */
    regs.FRACTALOS_CTX_SP = sp - 8u;
#else
    regs.FRACTALOS_CTX_SP = sp;    /* stack pointer: stack_top from loader  */
#endif
    regs.FRACTALOS_CTX_ARG0 = arg0; /* first argument: my_ep CNode slot */
    regs.FRACTALOS_CTX_ARG1 = arg1; /* second argument: ns_ep CNode slot */
