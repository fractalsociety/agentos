/*
 * FractalOS FreeBSD VMM — Virtual Machine Monitor
 *
...
static const seL4_CPtr g_virtio_blk_irq_cap =
    (seL4_CPtr)(FRACTALOS_IRQ_CAP_BASE + FREEBSD_VMM_BLK_IRQ_CAP_INDEX);
#if FREEBSD_VMM_HAS_NET_IRQ
static const seL4_CPtr g_virtio_net_irq_cap =
    (seL4_CPtr)(FRACTALOS_IRQ_CAP_BASE + 0u);    /* INTID 48, SPI 16 */
#endif
...
void init(void)
{
    LOG_VMM("FractalOS freebsd_vmm starting\n");
