/*
 * FractalOS Vibe Swap — Kernel-side hot-swap support — E5-S6: raw seL4 IPC
 *
...
/* ABI label constants (mirrors fractalos_service_abi.h) */
...
/*
 * Standalone-image entry point (fos-3ev).
 *
