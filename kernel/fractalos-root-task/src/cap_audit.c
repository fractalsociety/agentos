 ...
 *   - Under FRACTALOS_TEST_HOST the seL4 boot types are replaced by host-side
...
/*
 * Under FRACTALOS_TEST_HOST the following types and constants are expected to
 ...
 * baseline.  Under FRACTALOS_TEST_HOST this is a pure no-op; the host audit
