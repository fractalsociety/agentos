/*
 * FractalOS Agent Pool — Dynamic Agent Execution via Static PDs
 *
 ...
 * Each worker is a separate PD in fractalos.system.
 */
 ...
 * relay (cc_pd MSG_CC_LIST_POLECATS, see fos-681).
 *
...
void worker_pd_notified(uint32_t ch) {
    ...
    switch (ch) {
        case WORKER_CH_CONTROLLER: {
             ...
             * Execute the task.
             *
             * In the full FractalOS design, the "task" is a function pointer
