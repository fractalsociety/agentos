/* cap_policy_hotreload.c — Capability policy hot-reload for FractalOS
 *
 * Implements OP_CAP_POLICY_RELOAD: re-read the cap_policy CBOR blob from
 * AgentFS (sparky:8791/fractalos/cap-policy.cbor), parse it into the runtime
 ...
 * Companion files
 * ───────────────
 *   fractalos.h         — OP_CAP_POLICY_* opcode constants
...
/* AgentFS path hash for "fractalos/cap-policy.cbor" — precomputed djb2 */
#define POLICY_PATH_HASH_LO  0x9a4e2c1bu   /* djb2("fractalos/cap-policy.cbor") lo32 */
