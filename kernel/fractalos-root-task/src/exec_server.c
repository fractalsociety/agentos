/*
 * exec_server.c — ELF/WASM loader and execution dispatcher for FractalOS
 *
...
#define EXEC_APP_SLOTS     4u     /* must match fractalos.system app_slot count */
