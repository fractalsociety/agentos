/*
 * ext2fs.c — ext2 filesystem protection domain for FractalOS
 *
...
uintptr_t log_drain_rings_vaddr;       /* console ring region (fractalos.h)    */
...
void pd_main(seL4_CPtr my_ep, seL4_CPtr ns_ep) { ext2fs_main(my_ep, ns_ep); }
