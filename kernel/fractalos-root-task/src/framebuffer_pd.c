/*
 * framebuffer_pd.c — FractalOS Virtual Framebuffer Protection Domain  [E5-S7: raw seL4 IPC]
 *
...
void framebuffer_pd_main(seL4_CPtr my_ep, seL4_CPtr ns_ep)
{
    dbg_puts("[framebuffer_pd] starting — FractalOS virtual framebuffer service\n");
