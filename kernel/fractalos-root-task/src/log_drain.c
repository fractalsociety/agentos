/*
 * FractalOS Log Drain Protection Domain — E5-S1: raw seL4 IPC
 *
...
/* ── Ring header layout (matches log_ring_header_t in fractalos.h) ─────────── */
...
void log_drain_main(seL4_CPtr my_ep, seL4_CPtr ns_ep, seL4_CPtr serial_ep)
{
    ...
    uart_puts("[log_drain] starting — FractalOS log drain\n");
