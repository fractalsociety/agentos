/*
 * FractalOS Core Affinity Protection Domain
 *
 ...
 *
 * Channel assignments (fractalos.system):
...
{
    fractalos_log_boot("core_affinity");
...
void pd_main(seL4_CPtr my_ep, seL4_CPtr ns_ep) { core_affinity_main(my_ep, ns_ep); }
