/*
 * FractalOS NameServer Protection Domain
 *
 ...
 *
 * Design notes:
 *   - All channels are pre-wired in fractalos.system (Microkit constraint).
...
/* Shmem base for OP_NS_LIST dumps (mapped from fractalos.system) */
...
void pd_main(seL4_CPtr my_ep, seL4_CPtr ns_ep) { nameserver_main(my_ep, ns_ep); }
