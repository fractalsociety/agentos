/*
 * fractalos_agent — FractalOS Linux guest agent
 *
 ...
 *
 * Build:
 *   make -C userspace/linux/fractalos-agent
 * or:
 *   aarch64-linux-gnu-gcc -O2 -o fractalos-agent fractalos_agent.c
 *   x86_64-linux-gnu-gcc  -O2 -o fractalos-agent fractalos_agent.c
 *
